...
║  Total                      1      11      9     2    23         ║
╠══════════════════════════════════════════════════════════════════╣
║  Resolved by /gendoc-align-fix all (2026-05-08): 23 / 23 FIXED   ║
║  See [FIXED: <hash>] markers on each finding heading below.       ║
║  Re-run /gendoc-align-check to verify convergence to 0 findings. ║
╚══════════════════════════════════════════════════════════════════╝
```
...
### [HIGH] D1-01 — SCHEMA → EDD: Table-name divergence (admin_accounts vs admin_users) [FIXED: 27e2ab5]
...
### [HIGH] D1-02 — SCHEMA → EDD: Table-name divergence (admin_audit_log vs audit_logs) [FIXED: 27e2ab5]
...
### [HIGH] D1-03 — SCHEMA → EDD: Table-name divergence (marketplace_transactions vs trade_records) [FIXED: ef5c3a9]
...
### [HIGH] D1-04 — features/ ↔ docs/RTM.md: Duplicate feature directories (features/ AND features/server/) [FIXED: 61002ed]
...
### [HIGH] D1-05 — features/rarity-distribution.feature → PRD: Unknown US-ID `US-GEN-001` [FIXED: 5704911]
...
### [HIGH] D1-06 — RTM ↔ features/: Stale and incorrect coverage rows [FIXED: a83d4ea]
...
### [MEDIUM] D1-07 — features/ → PRD: US-ADMIN-006 has no BDD coverage [FIXED: 89dc960]
...
### [MEDIUM] D1-08 — features/trading-system.feature → PRD: Missing US-TRADE-001 tag [FIXED: 5704911]
...
### [MEDIUM] D1-09 — EDD → LOCAL_DEPLOY: No environment/port matrix in EDD [FIXED: ef5c3a9]
...
### [MEDIUM] D1-10 — EDD class diagram → SCHEMA: Class names diverge from table names [FIXED: 56f64fa]
...
### [LOW] D1-11 — RTM line 161: Stale "PRD Expansion Pending" note [FIXED: a83d4ea]
...
### [LOW] D1-12 — BDD-server.md → BDD-client.md: Both reference `features/server/` and `features/client/` [FIXED: c25061c]
...
### [CRITICAL] D4-01 — features/ structural duplication blocks test discovery [FIXED: 61002ed]
...
### [HIGH] D4-02 — PRD US-ADMIN-006 → No BDD scenario explicitly tagged [FIXED: 89dc960]
...
### [HIGH] D4-03 — PRD US-RECORD-001 marked Partial despite having a feature [FIXED: a83d4ea]
...
### [HIGH] D4-04 — PRD US-RARITY-001 underreported coverage [FIXED: a83d4ea]
...
### [MEDIUM] D4-05 — RTM ↔ docs/RTM.csv: Two RTM artifacts may diverge [FIXED: a83d4ea]
...
### [MEDIUM] D4-06 — test-plan.md → features/: test-plan references US-IDs that don't appear in features [FIXED: 5144339]
...
### [HIGH] D5-01 — EDD §3.8 missing 2-3 of the standard UML 9 diagrams [FIXED: ef5c3a9]
...
### [HIGH] D5-02 — Class Diagram lacks composition / aggregation / inheritance [FIXED: 5ae5bc1]
...
### [MEDIUM] D5-03 — Two RTM artifacts (RTM.md + RTM.csv); machine-readable RTM exists but Markdown copy is stale [FIXED: a83d4ea]

- See D4-05.

### [MEDIUM] D5-04 — Class diagram entity names diverge from SCHEMA table names [FIXED: 56f64fa]

- See D1-10. Class diagram uses `User` / `Leaderboard`; SCHEMA uses `claim_identities` / `leaderboard_snapshots`.

### [MEDIUM] D5-05 — Some PUML files are stubs [FIXED: 4fdb425]
